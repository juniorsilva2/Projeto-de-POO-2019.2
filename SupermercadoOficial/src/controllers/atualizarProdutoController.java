...
import aplication.AtualizarProduto;
...
public class atualizarProdutoController implements Initializable {
    ...
    @FXML TextField inputNomeDoProduto;
    @FXML TextField inputTipoProduto;
    @FXML TextField inputUnidadeMedida;
    @FXML TextField inputDescProduto;
    @FXML Button btnAtualizar;
    @FXML Button btnCancelar;


    public void close(){
        AtualizarProduto.getStage().close();
        retornaPrincipal();
    }
